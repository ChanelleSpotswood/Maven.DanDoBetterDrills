...
public class StringUtilities {
    ...
    public static String getPrefix(String input){
        String upToNCharacters = input.substring(0, Math.min(input.length(), 3));;
    ...
    public static String getSuffix(String input){
        String upToNCharacters = input.substring(2, Math.min(input.length(), 5));;
        return upToNCharacters;
    }
...
//    public static Character getFirstCharacter(String inputValue){
//        return inputValue.charAt(0);
//    }
//
//    public static Character getLastCharacter(String inputValue){
